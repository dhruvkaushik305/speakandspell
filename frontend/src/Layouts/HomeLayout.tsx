...
const HomeLayout: React.FC = () => {
  return (
    <div className="flex h-full flex-col items-center gap-16 overflow-y-auto overflow-x-hidden bg-white p-2">
      ...
      <div className="mx-8 flex flex-col gap-5 p-1">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1 rounded-xl bg-neutral-100 p-3">
          <AccordianComponent
